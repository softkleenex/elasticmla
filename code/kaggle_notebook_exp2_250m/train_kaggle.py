...
BATCH_SIZE = 4           # smaller microbatch: ~2x wider/deeper model than the 122M run.
GRAD_ACCUM_STEPS = 12    # keep effective batch size ~48 (4*12) for training stability.
D_MODEL = 1024
N_LAYERS = 16
N_HEADS = 16
D_HEAD = 64
D_ROPE = 32
D_C = 512            # KV latent dim -- primary axis of interest for ElasticMLA
